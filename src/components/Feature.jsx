        ...
        <div className='container mx-auto px-3 md:px-10'>
          <div className='px-5 py-32'>
            ...
            <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
              Immerse yourself in a rich and ever-expanding universe where a vibrant array of products converge into an interconnected overlay expreience on your world.
            </p>
          </div>
          ...
          <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
            <BentoTilt className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
              <BentoCard
                ...
                title={<>zig<b>m</b>a</>}
                description="An anime and gaming-insprired NFT ollection - the IP primed for expansion."
              />
            </BentoTilt>
